...
def try_backends():
    ...
    for b in candidates:
        ...
        try:
            ...
            print('mujoco.gl_context keys=', [k for k in dir(mujoco.gl_context) if not k.startswith('__')])
            print("_VALID_MUJOCO_GL=", getattr(mujoco.gl_context, '_VALID_MUJOCO_GL', None))
