...
if not os.path.exists(F):
    print('dump not found:', F); sys.exit(1)
...
print('file:', F)
print('shapes: model_out', model_out.shape, 'obs_hist', obs_hist.shape, 'ctrl', ctrl.shape, 'vel', vel.shape, 'pos', pos.shape, 'reward', reward.shape)
