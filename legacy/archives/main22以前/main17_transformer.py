...
class HideAndSeekEnv(gym.Env):
    ...
    def _get_obs(self, agent_id):
        ...
        def get_rel_info(target_id, lock=None):
            ...
            if (not refresh_vis) and target_id in cache:
        ...
        if agent_id == 0:
            ...
            h1 = infos[self.h1_body][:5]
            h2 = infos[self.h2_body][:5]
        ...
        infos = collect_rel_infos(specs)
        enemy = infos[self.s0_body][:5]
        friend = infos[partner]
