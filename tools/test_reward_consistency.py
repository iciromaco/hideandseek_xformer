...
def main():
    ...
    try:
        r_state, f_state, lh_state = env._compute_team_reward_state(pre_state_by_agent=pre_state_by_agent)
        print('_compute_team_reward_state ->', r_state, f_state, lh_state)
    except Exception as e:
