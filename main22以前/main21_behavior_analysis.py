...
try:
    ...
    from main21_layer0_runner import Layer0RunnerEnv as HideAndSeekEnv, Agent, ObsHistory
...
def plot_results(results, env):
    ...
    if results["capture_events"]:
        ...
        plt.scatter(caps[:, 0], caps[:, 1], marker='x', color='black', s=100, label='Capture Point', zorder=5)
